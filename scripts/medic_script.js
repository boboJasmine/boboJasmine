...
// const file2 = "../瑕疵完成/mask/mask.txt";
const folder1 = "./瑕疵完成/img/"; 
const folder2 = "./瑕疵完成/mask/";

// Promise.all([loadImageNames(folder1), loadImageNames(folder2)])
//     .then(([names1, names2]) => {
//         imageNames1 = names1;
//         imageNames2 = names2;
//     })
...
//                 document.querySelector('.scroll').setAttribute('class', ' ');
//                 // document.querySelector('a[href*=' + i + ']').setAttribute('class', 'scroll');
//             }
//         }
//     };
// })();
...
//     ('.slider-button').css('left', calc(sliderPos - 18))
// });

// --------------------------------------以下為動畫-------------------------------------------
// const firstElement = document.querySelector(".first");
// const nextElement = document.querySelector(".second");

// // 監控物件的位置
// function checkObjectPosition() {
//     const rect = firstElement.getBoundingClientRect();
//     if (rect.top < window.innerHeight / 0.53) {
//         // 清除背景設定
//         // nextElement.style.backgroundColor = "transparent";
//         firstElement.style.backgroundColor = "transparent";
//         // 加入slide-top動畫
//         nextElement.classList.add("slide-top-animation");
        
//         // 切換頁面
//         nextElement.classList.remove("second");
